...
cd /d D:\06 - NVIDIA\labs\Lab Basics 05\synthetic_data_generation_training_workflow\palletjack_sdg
...
python.bat "%SCRIPT_PATH%" --height 544 --width 960 --num_frames 2000 --distractors additional --data_dir "%OUTPUT_ADDITIONAL%"
python.bat "%SCRIPT_PATH%" --height 544 --width 960 --num_frames 1000 --distractors None --data_dir "%OUTPUT_NO_DISTRACTORS%"
